...
sudo docker run -P --volumes-from volumes_container -t compbio/ngseasy-bwa:v0.9 /usr/local/pipeline/bwa-0.7.10/bwa mem -t 8 /home/pipeman/reference_genomes_b37/human_g1k_v37.fasta \
